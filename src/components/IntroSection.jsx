      ...
      {isRsvpModalOpen && (
        <div className="fixed inset-0 z-[120] flex items-center justify-center bg-black/65 px-0">
          <div className="relative w-screen h-screen bg-[#fdf2f7] p-4 sm:p-6 shadow-[0_18px_45px_rgba(0,0,0,0.28)]">
            ...
            <div className="mt-8 flex h-[calc(100vh-114px)] w-full items-center justify-center overflow-hidden bg-white">
              <p className="font-poppins text-base uppercase tracking-[0.25em] text-[#80043a] sm:text-lg">
                To be added
              </p>
            </div>
          </div>
