  ...
  return (
    <>
      <section
        ...
        style={{ background: 'linear-gradient(180deg, #F8F1EA 0%, #E8C4C8 100%)' }}
      >
        {/* Content */}
        <div className="relative z-10">
          <div className="details-content-wrapper max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
            ...
            {/* RSVP Section */}
            <div className="details-subsection mb-12 lg:mb-0 text-center bg-[#F8F1EA]/85 border border-[#C98F9B] p-6">
              <h2
                ref={rsvpHeadingRef}
            ...
            <div className="details-subsection text-center bg-[#F8F1EA]/85 border border-[#C98F9B] p-6">
              <h2
                ref={giftHeadingRef}
