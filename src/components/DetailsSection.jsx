...
// Register ScrollTrigger pluginxsafewf
  ...
  return (
    <>
      <section
        ...
        style={{ background: 'linear-gradient(180deg, #FBF3F0 0%, #F0C9CE 100%)' }}
      >
        {/* Content */}
        <div className="relative z-10">
          <div className="details-content-wrapper max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
            ...
            {/* RSVP Section */}
            <div className="details-subsection mb-12 lg:mb-0 text-center bg-[#FBF3F0]/85 border border-[#D4A0A8] p-6">
              <h2
                ref={rsvpHeadingRef}
            ...
            <div className="details-subsection text-center bg-[#FBF3F0]/85 border border-[#D4A0A8] p-6">
              <h2
                ref={giftHeadingRef}
