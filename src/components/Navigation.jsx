        ...
        <div className={`${theme.container.maxWidth} ${theme.container.center} ${theme.container.padding}`}>
          <div className="flex items-center justify-between h-16">
            ...
            <div ref={logoRef} className="flex items-center space-x-2">
              <FiHeart className="h-8 w-8 text-[#5a4868] nav-heart" />
              ...
              {navItems.map((item) => {
                ...
                return (
                  <button
                    ...
                    className="flex items-center space-x-2 text-wedding-700 hover:text-[#5a4868] transition-all duration-200 hover:scale-105 active:scale-95"
                  >
            ...
            <button
              ...
              className="md:hidden p-2 rounded-md text-wedding-700 hover:text-[#5a4868] hover:bg-wedding-100 transition-colors duration-200"
            >
              ...
              {navItems.map((item) => {
                ...
                return (
                  <button
                    key={item.name}
                    onClick={() => scrollToSection(item.href, item.action)}
                    className="flex items-center space-x-3 w-full px-4 py-3 text-left text-wedding-700 hover:text-[#5a4868] hover:bg-wedding-100 rounded-md transition-all duration-200 hover:translate-x-2"
                  >
                    <Icon className="h-5 w-5" />
                    <span>{item.name}</span>
                  </button>
